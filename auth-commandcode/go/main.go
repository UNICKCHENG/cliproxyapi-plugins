// Command commandcode implements a CLIProxyAPI provider plugin for the Command Code Provider API.
//
// The plugin exposes the "commandcode" provider key through the executor, auth provider and
// model provider capabilities. Upstream calls go to the documented HTTP endpoints
// /provider/v1/chat/completions and /provider/v1/messages.
package main
...
// and are already capped separately; the extra headroom covers JSON wrapping.
...
const providerIdentifier = "commandcode"
